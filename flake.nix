{
  description = "OpenStream — desktop livestreaming app";
  ...
  outputs =
    ...
    in
    {
      ...
      packages = forAllSystems (pkgs: {
        openstream = pkgs.callPackage ./nix/package.nix { };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "OpenStream dev shell — node $(node --version), electron v$(electron --version 2>/dev/null | tr -d 'v')"
            '';
          };
        }
      );
      ...
      overlays.default = final: _prev: {
        openstream = self.packages.${final.stdenv.hostPlatform.system}.openstream;
      };
